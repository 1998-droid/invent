                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="date" class="form-control" name="tahun" id="floatingInputGrid"
                                                placeholder="Tahun Pembuatan Dokumen" required>
                                            <label for="floatingInputGrid">Tahun Pembuatan Dokumen</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="tentang"
                                                id="floatingInputGrid" placeholder="Tentang" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="subag"
                                                value="<?=($_SESSION['subag'])?>" id="floatingInputGrid"
                                                placeholder="Subag" required readonly>
                                            <label for="floatingInputGrid">Subag</label>
                                        </div>
                                    </div>
                                    <div class="row g-2">
