...
<?php
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" name="n_dok" id="floatingInputGrid" value="<?=($data['subag'])?>" placeholder="nama" required>
    ...
    <div class="col-md-4 mt-4">
        <div class="form-floating">
        <embed src="file/<?php echo $data['file'];?>" name="id_2" type="application/pdf" width="250" height="250">
    </div>
    </div>
