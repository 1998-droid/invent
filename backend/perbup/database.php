<div class="table-responsive">
    <table class="table table-borderless" id="datatablesSimple" width="100%" cellspacing="0">
        ...
        <tbody>
            <?php
$sql = mysqli_query($koneksi, "SELECT a.id_perbup , a.nama, a.tahun, a.tgl_upload, a.subag, a.file FROM tb_perda a JOIN tb_user b ON a.subag=b.subag WHERE user='$_SESSION[username]' ")
...
while ($data = mysqli_fetch_array($sql)) {
    ?>
            ...
            <tr>
                ...
                <td><a href="preview.php?id=<?php echo $data['id_perbup']; ?>" class="btn btn-primary btn-sm"
                        data-toggle="tooltip" data-placement="top" title="Detail"><i class="fa-solid fa-circle-info"
                            aria-hidden="true"></i></a>
                    <a href="edit.php?id=<?php echo $data['id_perbup']; ?>" class="btn btn-info btn-sm"
                        data-toggle="tooltip" data-placement="top" title="Edit dokumen"><i
                            class="fa-solid fa-pen-to-square" aria-hidden="true"></i></a>
                    <a href="hps.php?id=<?php echo $data['id_perbup']; ?>" onclick="return confirm('Yakin Hapus?')"
