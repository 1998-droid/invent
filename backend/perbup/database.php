<div class="table-responsive">
    <table class="table table-borderless" id="datatablesSimple" width="100%" cellspacing="0">
        ...
        <tbody>
            <?php
$sql = mysqli_query($koneksi, "SELECT a.id_dok, a.nama, a.tahun, a.tgl_upload, a.subag, a.file FROM tb_dok a JOIN tb_user b ON a.subag=b.subag WHERE user='$_SESSION[username]'
&& a.jenis_dok='perbup' ")
...
while ($data = mysqli_fetch_array($sql)) {
    ?>
            ...
            <tr>
                ...
                <td><a href="preview.php?id=<?php echo $data['id_dok']; ?>" class="btn btn-primary btn-sm"
                        data-toggle="tooltip" data-placement="top" title="Detail"><i class="fa-solid fa-circle-info"
                            aria-hidden="true"></i></a>
                    <a href="edit.php?id=<?php echo $data['id_dok']; ?>" class="btn btn-info btn-sm"
