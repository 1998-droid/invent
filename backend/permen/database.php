...
while ($data = mysqli_fetch_array($sql)) {
    ?>
            ...
            <tr>
                ...
                <td><a href="preview.php?id=<?php echo $data['id_permen']; ?>" class="btn btn-primary btn-sm"
                        data-toggle="tooltip" data-placement="top" title="Detail"><i class="fa-solid fa-circle-info"
                            aria-hidden="true"></i></a>
                    <a href="edit.php?id=<?php echo $data['id_permen']; ?>" class="btn btn-info btn-sm"
                        data-toggle="tooltip" data-placement="top" title="Edit dokumen"><i
                            class="fa-solid fa-pen-to-square" aria-hidden="true"></i></a>
                    <a href="hps.php?id=<?php echo $data['id_permen']; ?>" onclick="return confirm('Yakin Hapus?')"
