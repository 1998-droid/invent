<div class="table-responsive">
    <table class="table table-borderless" id="datatablesSimple" width="100%" cellspacing="0">
        ...
        <tbody>
            <?php
$sql = mysqli_query($koneksi, "SELECT a.id_perda , a.nama, a.tahun, a.tgl_upload, a.subag, a.file FROM uu a JOIN tb_user b ON a.subag=b.subag WHERE user='$_SESSION[username]' ")
