<div class="table-responsive">
     <table class="table table-borderless" id="datatablesSimple" width="100%" cellspacing="0">
        ...
        <tbody>
        <?php
$sql = mysqli_query($koneksi, "SELECT a.id_dok, a.n_dok, a.subag, a.file, a.tgl, a.tentang, a.nomor FROM tb_dok a JOIN tb_user b ON a.subag=b.subag WHERE user='$_SESSION[username]' ")
