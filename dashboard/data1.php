    ...
    ?>
                        <tbody>
                            <tr>
                                ...
                                <td><a href="preview.php?id=<?php echo $data['id_kepeg']; ?>"
                                        class="btn btn-primary btn-sm">Preview</a></td>
                                <td><a href="hps.php?id=<?php echo $data['id_kepeg']; ?>"
                                        onclick="return confirm('Yakin Hapus?')" class="btn btn-danger btn-sm">Hapus</a>
                                </td>
                            </tr>
                            <?php
}
